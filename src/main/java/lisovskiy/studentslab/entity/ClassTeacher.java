...
@NamedQueries({
    ...
    @NamedQuery(name = "ClassTeacher.findById", query = "SELECT c FROM ClassTeacher c WHERE c.id = :id")})
public class ClassTeacher implements Serializable {
    ...
    public ClassTeacher(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "lisovskiy.studentslab.entity.ClassTeacher[ id=" + id + " ]";
    }
